...
service CatalogService@(path:'/CatalogService') {
  ...
  entity UniqueEquipMaintplant as select distinct plant,plantDescription from EquipMaint;
  entity UniqueEquipMaintMachineid as select distinct machineID,machineDescription from EquipMaint;
